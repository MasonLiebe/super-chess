      ...
      <div className="min-h-screen bg-[var(--bg-page)] flex items-center justify-center p-4">
        <div className="max-w-sm w-full">
          <div className="bg-[var(--bg-card)] border-4 border-[var(--border-color)] shadow-[8px_8px_0px_var(--shadow-color)] p-8 text-center">
            <h1 className="text-3xl font-black text-[var(--text-primary)] mb-4">INVALID LINK</h1>
            <p className="text-[var(--text-secondary)] mb-4">This reset link is missing a token.</p>
            <Link to="/forgot-password" className="text-[var(--text-primary)] font-bold underline">
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[var(--bg-page)] flex items-center justify-center p-4">
        <div className="max-w-sm w-full">
          <div className="bg-[var(--bg-card)] border-4 border-[var(--border-color)] shadow-[8px_8px_0px_var(--shadow-color)] p-8 text-center">
            <h1 className="text-3xl font-black text-[var(--text-primary)] mb-4">PASSWORD RESET</h1>
            <div className="p-3 bg-[#00b894] border-2 border-[var(--border-color)] text-[var(--color-dark)] font-medium text-sm mb-4">
    ...
    <div className="min-h-screen bg-[var(--bg-page)] flex items-center justify-center p-4">
      <div className="max-w-sm w-full">
        <div className="bg-[var(--bg-card)] border-4 border-[var(--border-color)] shadow-[8px_8px_0px_var(--shadow-color)] p-8">
          <h1 className="text-3xl font-black text-[var(--text-primary)] mb-6 text-center">RESET PASSWORD</h1>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block font-bold text-[var(--text-primary)] mb-1">NEW PASSWORD</label>
              <input
                type="password"
                value={password}
